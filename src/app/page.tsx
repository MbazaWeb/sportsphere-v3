...
import { PROFILE_TYPES } from '@/components/profiles/profileConfig';
  ...
  return (
    <div className="fixed top-4 left-1/2 z-50 -translate-x-1/2 pointer-events-none">
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
        className="rounded-xl bg-surface-elevated border border-surface-border px-4 py-3 shadow-lg">

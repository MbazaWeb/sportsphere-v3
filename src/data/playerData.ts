// SportSphere — Rich player, team & competition data
// Used by TabContent for detailed profile rendering
...
export const COMPETITION_DATA = {
  premierLeague: {
    ...
    standings: [
      { pos: 1, team: 'Manchester City',   p: 15, w: 12, d: 2, l: 1,  gd: '+24', pts: 38 },
      { pos: 2, team: 'Arsenal',           p: 15, w: 11, d: 3, l: 1,  gd: '+21', pts: 36 },
      { pos: 3, team: 'Liverpool',         p: 15, w: 11, d: 2, l: 2,  gd: '+18', pts: 35 },
      { pos: 4, team: 'Aston Villa',       p: 15, w: 9,  d: 4, l: 2,  gd: '+12', pts: 31 },
      { pos: 5, team: 'Tottenham',         p: 15, w: 9,  d: 2, l: 4,  gd: '+8',  pts: 29 },
      { pos: 6, team: 'Manchester United', p: 15, w: 8,  d: 3, l: 4,  gd: '+6',  pts: 27 },
      { pos: 7, team: 'Newcastle',         p: 15, w: 7,  d: 4, l: 4,  gd: '+4',  pts: 25 },
      { pos: 8, team: 'Chelsea',           p: 15, w: 7,  d: 3, l: 5,  gd: '+2',  pts: 24 },
    ],
  },
};

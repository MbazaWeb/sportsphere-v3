    ...
    <div className="mx-auto flex max-w-lg flex-col items-center px-6 pt-12">
      ...
      >
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-2xl bg-gold shadow-[0_8px_30px_rgba(245,197,24,0.3)]">
            <span className="text-3xl font-black text-black">SS</span>
          </div>
          <h1 className="text-2xl font-black text-gold-gradient">Welcome to SportSphere</h1>
        ...
        <div className="mb-6 flex flex-col gap-3">
          ...
          <button
            ...
            className="flex h-14 items-center justify-center gap-2 rounded-2xl bg-gold text-sm font-bold text-black transition-all hover:bg-gold/90 active:scale-[0.98] shadow-[0_4px_20px_rgba(245,197,24,0.2)]"
          >
          ...
          <div className="flex gap-2">
            <button className="flex h-12 flex-1 items-center justify-center gap-2 rounded-xl glass-card text-sm font-semibold text-white transition-colors hover:bg-surface-elevated">
        ...
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div key={label} className="flex flex-col items-center gap-2 rounded-2xl glass-card p-4 glass-card-hover">
    ...
    <div>
      ...
      <header className="sticky top-0 z-40 border-b border-surface-border bg-background/90 backdrop-blur-xl">
        <div className="flex h-14 items-center justify-between px-4">
          <h1 className="text-lg font-black text-gold-gradient">Profile</h1>
      ...
      <div className="p-4">
        ...
        <div className="mb-6 flex items-start gap-4">
          <div className="relative">
            ...
            <button className="absolute bottom-0 right-0 flex h-7 w-7 items-center justify-center rounded-full bg-gold shadow-[0_2px_10px_rgba(245,197,24,0.3)]">
              <Camera className="h-3.5 w-3.5 text-black" />
            </button>
          </div>
          <div className="flex-1">
            <div className="flex items-center gap-2 flex-wrap">
              <h2 className="text-xl font-black text-white">{userProfile?.name || 'David Mbaza'}</h2>
            ...
            <div className="mt-2 flex items-center gap-2 flex-wrap">
              {isAdvanced && (
                <span className="rounded-lg bg-gold/10 border border-gold/20 px-2.5 py-1 text-[10px] font-bold text-gold uppercase">
                  {userProfile?.role}
                </span>
              )}
        ...
        {/* Stats */}
        <div className="mb-6 grid grid-cols-4 gap-3 rounded-2xl glass-card p-4 glass-card-hover">
          <div className="text-center">
            <p className="text-lg font-black text-gold">1.2K</p>
            <p className="text-[10px] text-muted-foreground uppercase">Followers</p>
          </div>
          <div className="text-center">
            <p className="text-lg font-black text-gold">345</p>
            <p className="text-[10px] text-muted-foreground uppercase">Following</p>
          </div>
          <div className="text-center">
            <p className="text-lg font-black text-gold">52</p>
            <p className="text-[10px] text-muted-foreground uppercase">Posts</p>
          </div>
          <div className="text-center">
            <p className="text-lg font-black text-gold">89%</p>
        ...
        {userProfile?.sportsFollowing && userProfile.sportsFollowing.length > 0 && (
          <div className="mb-6">
            <h3 className="mb-2 text-xs font-bold text-gold uppercase tracking-wider">Sports Following</h3>
          ...
          {profileTabs.map((tab) => (
            <button
              ...
              className={cn(
                ...
                activeTab === tab.id
                  ? 'bg-gold text-black shadow-[0_2px_10px_rgba(245,197,24,0.2)]'
        ...
        <div className="mt-6">
          <button
            onClick={() => onNavigate('settings')}
            className="flex w-full items-center justify-between glass-card rounded-xl p-4 glass-card-hover"
          >
          ...
          <div className="mt-2 grid grid-cols-3 gap-2">
            {moreItems.map((item) => (
              <button
                ...
                className="flex flex-col items-center gap-2 glass-card rounded-xl p-4 glass-card-hover"
              >
        ...
        <div className="flex flex-col gap-2">
            ...
            <>
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-gold py-2.5 text-xs font-bold text-black hover:bg-gold/90 transition-colors shadow-[0_2px_10px_rgba(245,197,24,0.2)]"
                >
          ...
          {isRejected && (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gold py-2.5 text-xs font-bold text-black hover:bg-gold/90 transition-colors shadow-[0_2px_10px_rgba(245,197,24,0.2)]"
            >
          ...
          {isVerified && (
            <div className="flex items-center justify-center gap-2 rounded-xl bg-gold/10 border border-gold/20 p-3">
              ...
              <span className="text-xs font-bold text-gold">Verified Badge Active</span>
            </div>
          )}
        </div>
      </div>
    ...
    <div>
      <header className="sticky top-0 z-40 border-b border-surface-border bg-background/90 backdrop-blur-xl">
        <div className="flex h-14 items-center gap-3 px-4">
          ...
          <h1 className="text-lg font-black text-gold-gradient">Settings</h1>
        </div>
      </header>
      ...
      <div className="p-4">
        {settingsSections.map((section) => (
          <div key={section.title} className="mb-6">
            <h2 className="mb-2 text-xs font-bold text-gold uppercase tracking-wider">{section.title}</h2>
            <div className="flex flex-col gap-1 rounded-2xl glass-card overflow-hidden">
    ...
    <div>
      <header className="sticky top-0 z-40 border-b border-surface-border bg-background/90 backdrop-blur-xl">
        <div className="flex h-14 items-center gap-3 px-4">
          ...
          <h1 className="text-lg font-black text-gold-gradient">{title}</h1>
        </div>
      </header>
  ...
  return (
    <div>
      ...
      <div className="p-4">
        <div className="flex flex-col gap-2">
          {people.map((person) => (
            <div key={person.handle} className="flex items-center gap-3 glass-card rounded-xl p-3 glass-card-hover">
              ...
              <button className="rounded-lg bg-gold/10 border border-gold/20 px-3 py-1.5 text-xs font-bold text-gold hover:bg-gold/20 transition-colors">

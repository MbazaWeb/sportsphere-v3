...
import { X, ChevronRight, Check, Sparkles, Users } from 'lucide-react';
...
function FanStep({ onBack, onComplete }: { onBack: () => void; onComplete: (data: { name: string; email: string; handle: string; password: string; sports: string[] }) => void }) {
  ...
  return (
    <div>
      ...
      <p className="mb-4 text-sm text-muted-foreground">Create your fan account and start following your favorite sports.</p>
      ...
      <div className="mb-6">
        ...
        <div className="flex flex-wrap gap-2">
          {SPORTS_FALLBACK.slice(0, 10).map(sport => (

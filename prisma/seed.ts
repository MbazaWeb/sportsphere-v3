...
async function main() {
  ...
  const postDefs = [
    ...
    // ── Spotlight / Video posts ──────────────────────────────────
    { userId: userMap['@goalsdaily'].id, postType: 'spotlight', isBreaking: false,
      content: 'Rashford goal vs Arsenal — pure class 🔥 #MUFC #Rashford',
      playerTag: 'Marcus Rashford', likeCount: 124000, commentCount: 8900, shareCount: 34000, viewCount: 2100000 },
    { userId: userMap['@goalsdaily'].id, postType: 'spotlight', isBreaking: false,
      content: 'Haaland hat-trick compilation — unstoppable this season ⚽⚽⚽ #Haaland #ManCity',
      playerTag: 'Erling Haaland', likeCount: 89000, commentCount: 5600, shareCount: 21000, viewCount: 1800000 },
    { userId: userMap['@sarahchen'].id, postType: 'spotlight', isBreaking: false,
      content: 'Emirates matchday vibes — this is what football is about ❤️ #Arsenal',
      teamTag: 'Arsenal', likeCount: 45000, commentCount: 2300, shareCount: 8900, viewCount: 890000 },
    { userId: userMap['@manchesterunited'].id, postType: 'spotlight', isBreaking: false,
      content: 'Old Trafford electric tonight. Theatre of Dreams never disappoints 🔴 #MUFC',
      teamTag: 'Manchester United', likeCount: 67000, commentCount: 4500, shareCount: 12000, viewCount: 1200000 },
    { userId: userMap['@goalsdaily'].id, postType: 'video', isBreaking: false,
      content: 'Top 10 goals of the month — which one is your favourite? 🎯',
      likeCount: 56000, commentCount: 3400, shareCount: 9800, viewCount: 780000 },
    { userId: userMap['@gkunion'].id, postType: 'spotlight', isBreaking: false,
      content: 'Best saves of the week 🧤 #GKUnion',
      likeCount: 34000, commentCount: 1200, shareCount: 5600, viewCount: 450000 },
    { userId: userMap['@fabrizioromano'].id, postType: 'video', isBreaking: false,
      content: 'Transfer deadline day RECAP — every deal, every here we go ✅ #Transfers',
      likeCount: 78000, commentCount: 6700, shareCount: 23000, viewCount: 1500000 },
    { userId: userMap['@rashford10'].id, postType: 'spotlight', isBreaking: false,
      content: 'Behind the scenes training at Carrington 💪 #MUFC',
      likeCount: 89000, commentCount: 4500, shareCount: 15000, viewCount: 2300000 },
    { userId: userMap['@pepguardiola'].id, postType: 'video', isBreaking: false,
      content: 'Pre-match tactics breakdown — pressing high, winning the midfield ⚽',
      likeCount: 34000, commentCount: 2300, shareCount: 7800, viewCount: 560000 },
    { userId: userMap['@sportsphere'].id, postType: 'spotlight', isBreaking: false,
      content: "AFCON 2025 highlights — Africa's finest on the biggest stage 🌍🏆 #AFCON2025",
      likeCount: 45000, commentCount: 3400, shareCount: 12000, viewCount: 890000 },
    { userId: userMap['@salah11'].id, postType: 'spotlight', isBreaking: false,
      content: 'Match day goals compilation — Anfield roars every time ❤️ #LFC #Salah',
      teamTag: 'Liverpool', likeCount: 156000, commentCount: 9800, shareCount: 45000, viewCount: 3400000 },
    { userId: userMap['@arsenal'].id, postType: 'spotlight', isBreaking: false,
      content: 'Saka skills and goals — the best of our number 7 this season 🎯 #Saka #Arsenal',
      teamTag: 'Arsenal', likeCount: 89000, commentCount: 5600, shareCount: 23000, viewCount: 1600000 },
  ];
